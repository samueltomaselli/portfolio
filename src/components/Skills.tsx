...
export const Skills = () => {
  return (
    <div id="skills" className="bg-white text-white dark:bg-primary-900 flex flex-col items-center gap-24 pt-20 pb-20 z-10 max-sm:gap-20 max-sm:pt-10 max-sm:pb-10">
      <Fade delay={100} className="w-4/6 flex flex-col items-center">
        <h1 className="text-4xl font-bold  dark:text-white text-primary-900">Habilidades 💪</h1>
