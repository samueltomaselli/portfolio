...
export const ProjectBox2 = ({ url }: Props) => {
  ...
  return (
    <div className="flex justify-center items-center h-64 border-2 border-primary-100 rounded-xl hover:cursor-pointer hover:scale-105 transition-all shadow-sm shadow-primary-100 max-lg:w-2/3 max-sm:w-full relative">
