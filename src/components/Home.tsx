...
export const Home = () => {
  ...
  return (
    <div
      id="home"
      className="h-[calc(100vh-96px)] flex justify-center w-full bg-white dark:bg-primary-900 dark:text-primary-100 text-primary-100 z-10 pb-10 max-sm:gap-20 max-sm:pb-10 max-lg:pt-10 max-sm:pt-5 "
    >
