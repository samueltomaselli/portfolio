...
export const Home = () => {
  ...
  return (
    <div
      id="home"
      className="min-h-[calc(100vh-96px)] flex justify-center max-[400px]:min-h-full max-[400px]:items-start max-[400px]:pt-20 max-[400px]:pb-10 items-center w-full bg-white dark:bg-primary-900 dark:text-primary-100 text-primary-100 z-10 max-sm:gap-20 "
    >
