      ...
      <Fade delay={100} className="w-4/6 flex flex-col items-center ">
        ...
        <div className="full rounded-xl flex items-center gap-16 dark:text-white text-primary-900 max-lg:flex-col">
          <div className="w-3/5 font-bold flex flex-col gap-5 max-lg:w-full">
            ...
            <p className="text-lg dark:text-white text-start font-medium tracking-widest first-line:tracking-widest first-letter:text-5xl first-letter:font-bold dark:first-letter:text-white first-letter:text-black first-letter:mr-3 first-letter:float-left max-sm:text-sm">
